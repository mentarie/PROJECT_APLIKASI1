  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017<?php if(date('Y')>2017){echo '-'.date('Y');};?> <a href="<?php echo base_url();?>">Sastro Leo</a>.</strong> Hak cipta dilindungi Tuhan.
  </footer>
...
<!-- Sparkline -->
<script src="<?php echo base_url('assets/adminlte/2.4.0').'/';?>bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="<?php echo base_url('assets/adminlte/2.4.0').'/';?>plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo base_url('assets/adminlte/2.4.0').'/';?>plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('assets/adminlte/2.4.0').'/';?>bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
