...
<head>
  ...
  <title>Praktek Kerja Lapangan</title>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte/2.4.0').'/';?>bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte/2.4.0').'/';?>plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  ...
  <!-- CKEditor -->
  <!-- <script src="<?php echo base_url('assets/adminlte/2.4.0').'/';?>bower_components/ckeditor/ckeditor.js"></script> -->
  <!-- <script src="<?php echo base_url('assets/plugins/ckeditor/ckeditor.js');?>"></script> -->
  <script src="<?php echo base_url('assets/plugins/ckeditor-full/ckeditor/ckeditor.js');?>"></script>
  <script src="<?php echo base_url('assets/js/prakerin-custom_ckeditor.js');?>"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index').'/';?>" class="logo">
      ...
      <span class="logo-lg"><b>PKL</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/adminlte/2.4.0').'/';?>dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/adminlte/2.4.0').'/';?>dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/adminlte/2.4.0').'/';?>dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets').'/';?>img/no_account_photo.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->nama_lengkap;?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php echo ucwords(strtolower($this->session->nama_lengkap));?>
