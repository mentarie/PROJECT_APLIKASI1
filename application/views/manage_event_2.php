...
<body data-spy="scroll" data-target=".mainmenu-area">
            ...
            <div class="row" >
                ...
                <div class="col-xs-12 col-md-7">
                    <div class="subscribe-form text-center">
                        <h3 class="blue-color">Get Your Event Code and<br> Tracking Link</h3>
                        <div class="space-20"></div>
                        <div class="table-responsive" style="overflow:hidden;">
                            <table class="table table-striped table-bordered table-hover text-left" id="dataTables-customer" style="font-size:14px;color: grey">
                                <thead>
                                    <tr>
                                        <td>NAME:</td>
                                        <td >YOUR_EVENT_NAME</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>LINK:</td>
                                        <td>
                                            <a href="dashboard_tracking" target="_blank">http://localhost/dimdee_project/dashboard_tracking/unique_id</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <script src="assets/plugins/dataTables/extensions/buttons.html5.min.js"></script>
    <script src="assets/plugins/dataTables/extensions/buttons.print.min.js"></script>
    <script src="assets/plugins/dataTables/extensions/FixedColumns/js/dataTables.fixedColumns.min.js"></script>
    <script src="assets/plugins/dataTables/extensions/dataTables.buttons.min.js"></script>
    <script src="assets/plugins/dataTables/extensions/jszip.min.js"></script>
    <script src="assets/plugins/dataTables/extensions/pdfmake.min.js"></script>
    <script src="assets/plugins/dataTables/extensions/vfs_fonts.js"></script>
</body>
