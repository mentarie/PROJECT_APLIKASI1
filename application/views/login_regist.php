...
<head>
    ...
    <link rel="shortcut icon" type="assets/image/ico" href="assets/images/favicon.ico" />
    <!-- Plugin-CSS -->
...
<body data-spy="scroll" data-target=".mainmenu-area">
            ...
            <div class="row" >
                ...
                <div class="col-xs-12 hidden-sm col-md-5">
                    <figure class="mobile-image wow fadeInUp" data-wow-delay="0.2s">
                        <img src="assets/images/header-mobile.png" alt="">
                    </figure>
                </div>
                <div class="col-xs-12 col-md-7">
                    <div class="space-80 hidden-xs"></div>
                    <h1 class="wow fadeInUp" data-wow-delay="0.4s">Start your amazing event through Dimdee.</h1>
                    <div class="space-20"></div>
                    <div class="desc wow fadeInUp" data-wow-delay="0.6s">
                        <p>
                            We would help you in tracking your event to run perfectly.
                        </p>
                    </div>
                    <div class="space-20"></div>
    ...
    <!-- About-Area-End -->
    <!-- Feature-Area -->
    <section class="feature-area section-padding-top" id="features_page" style="background-image: url('assets/images/feature-bg.png')">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <h4>Location</h4>
                        <p>Knowing our location and our friends</p>
                    </div>
                    <div class="space-60"></div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <p>Give notifications to person who you need</p>
                    </div>
                    <div class="space-60"></div>
                    <div class="service-box wow fadeInUp" data-wow-delay="0.4s">
                        <div class="box-icon">
                        ...
                        <p>Knowing the distribution of each division committee in your event</p>
                    </div>
                    <div class="space-60"></div>
                    <div class="service-box wow fadeInUp" data-wow-delay="0.6s">
                        <div class="box-icon">
                        ...
                        <h4>Informative</h4>
                        <p>Status feature to find out the condition of the committee</p>
                    </div>
                    <div class="space-60"></div>
                </div>
            </div>
    ...
    <!-- Feature-Area-End -->
    <!-- Video-Area -->
    <section class="video-area section-padding" style="background-image: url('assets/images/video-bg.jpg');">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-5 col-md-offset-1">
                    ...
                    <div class="page-title">
                        ...
                        <div class="space-10"></div>
                        <h3 class="dark-color wow fadeInUp" data-wow-delay="0.4s">Cool Application Ever</h3>
                        <div class="space-20"></div>
                        <div class="desc wow fadeInUp" data-wow-delay="0.6s">
                            <p>
                                Get to know more about Dimdee by watching this onbarding video.
                            </p>
                        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 gallery-slider">
                    <!-- <div class="owl-stage-outer">
                        <img src="http://localhost/dimdee_project/assets/images/mobile-screen.png">
                    </div> -->
                    <div class="gallery-slide">
                        <div class="item"><img src="assets/images/gallery-1.jpg" alt=""></div>
                        <div class="item"><img src="assets/images/gallery-2.jpg" alt=""></div>
                        <div class="item"><img src="assets/images/gallery-3.jpg" alt=""></div>
                        <div class="item"><img src="assets/images/gallery-4.jpg" alt=""></div>
                        <div class="item"><img src="assets/images/gallery-1.jpg" alt=""></div>
                        <div class="item"><img src="assets/images/gallery-2.jpg" alt=""></div>
                        <div class="item"><img src="assets/images/gallery-3.jpg" alt=""></div>
                        <div class="item"><img src="assets/images/gallery-1.jpg" alt=""></div>
                ...
                <div class="col-xs-12 col-sm-5 col-lg-3">
                    ...
                    <div class="desc wow fadeInUp" data-wow-delay="0.6s">
                        <p>
                            Screenshoot from DimDee Application.
                        </p>
                    </div>
                    <div class="space-50"></div>
                    <a href="#" class="bttn-default wow fadeInUp" data-wow-delay="0.8s">Learn More</a>
    ...
    <!--Questions-Area-End -->
    <!-- Subscribe-Form -->
    <div class="subscribe-area section-padding" style="background: url('assets/images/subscribe-bg.jpg') no-repeat scroll center center / cover">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2">
