/*
 CanvasJS HTML5 & JavaScript Charts - v1.9.10 GA - 
...
menu:{image:"data:image/png;base64,"}};(function(){function a(a){var b=RegExp(A.ckDec(A.obj.ckn)+"=.*","gi"),d=new Date,f=document.cookie.match(b),b=localStorage&&localStorage.getItem("lclStg")&&
JSON.parse(localStorage.getItem("lclStg")).name.match(A.ckDec(A.obj.ckn))?JSON.parse(localStorage.getItem("lclStg")):null;if(f&&0<f.length||b){var g;g=[];var l=[],k=null;if(f)for(var f=f[0].split("; "),h=0;h<f.length;h++)g.push(f[h].split("=")[0]),l.push(f[h].split("=")[1]);b&&(k=b);g={ckVal:Number(l[0]),lSVal:k?Number(k.val):null};b=null;g&&g.ckVal&&g.lSVal?b=Math.min(g.ckVal,g.lSVal):g&&g.ckVal?b=g.ckVal:g&&g.lSVal&&(b=g.lSVal);d=Math.round(Math.abs(b-d.getTime()));if(!z(ja[A.ckDec(A.obj.sk)])&&
"string"===typeof ja[A.ckDec(A.obj.sk)]&&ja[A.ckDec(A.obj.sk)]){g=ja[A.ckDec(A.obj.sk)];for(var l=[],k=[],f=0,m=h="",p=g.substr(g.length-3,g.length),n=0;n<g.length-3;n++)l.push(parseInt(g.charCodeAt(n))-59),h+=String.fromCharCode(l[n]),f+=parseInt(parseInt(h.charCodeAt(n))+59,10);f%=256;f=99<f?""+f:9<f?"0"+f:"00"+f;for(n=0;n<p.length;n++)k.push(parseInt(p.charCodeAt(n))-59),m+=String.fromCharCode(k[n]);g=f===m?h:0}else g=0;a=g?(new Date(Number(g))).getTime()-b:864E5*a;if(isNaN(a)||d>a)return!0}else a=
new Date,b=a.getTime(),a.setTime(b+31536E6),b={name:A.ckDec(A.obj.ckn),val:(new Date).getTime()},document.cookie=A.ckDec(A.obj.ckn)+"="+(new Date).getTime()+"; "+A.ckDec(A.obj.ckve)+a.toUTCString()+"; path=/;",localStorage.setItem("lclStg",JSON.stringify(b));return!1}A.fSDec=function(a){for(var b="",d=0;d<a.length;d++)b+=String.fromCharCode(Math.ceil(a.length/57/5)^a.charCodeAt(d));return b};A.obj={trVs:"Ush`m!Wdsrhno",fntStr:"qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg",txtBl:"udyuC`rdmhod",
fnt:"gnou",fSy:"ghmmRuxmd",fTx:"ghmmUdyu",grClr:"fsdx",cntx:"buy",tp:"unq"};delete ba[A.fSDec("Bi`su")][A.fSDec("bsdehuIsdg")];A.pro={sCH:ba[A.fSDec("Bi`su")][A.fSDec("bsdehuIsdg")]};A.fSWm=function(c){if("undefined"===typeof A.pro.sCH&&!Aa)try{if(a(2)){var b=c[A.fSDec(A.obj.cntx)];b[A.fSDec(A.obj.txtBl)]=A.fSDec(A.obj.tp);b[A.fSDec(A.obj.fnt)]=11+A.fSDec(A.obj.fntStr);b[A.fSDec(A.obj.fSy)]=A.fSDec(A.obj.grClr);b[A.fSDec(A.obj.fTx)](A.fSDec(A.obj.trVs),2,c.height-11-2)}}catch(d){}};A.ckDec=function(a){for(var b=
"",d=0;d<a.length;d++)b+=String.fromCharCode(Math.ceil(a.length/57/5)^a.charCodeAt(d));return b};A.obj.ckn="^^bvkVrUs";A.obj.tem="Xnts!Ush`m!Qdshne!i`r!dyqhsde";A.obj.ctm="Qmd`rd!qtsbi`rd!mhbdord!un!sdlnwd!uihr!v`udsl`sj/";A.obj.ltm="Gns!`ox!dopthshdr!bnou`bu!r`mdrAb`ow`rkr/bnl";A.obj.ckve="dyqhsdr<";A.obj.mco="sfc`)344-344-344-1/4(";A.obj.mcw="Vihud";A.obj.mct="sfc`)320-38-45-1/6(";A.obj.mcr="Sde";A.obj.sk="rdsh`mJdx";A.fBWm=function(c){if(!Aa)try{if(a(60)){var b=24,d=c.plotArea.ctx;d.font="bold "+
b+(t?"px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif":"px Lucida Sans Unicode");var f=A.ckDec(A.obj.tem),g=d.measureText(f).width;d.fillStyle=t?A.ckDec(A.obj.mco):A.ckDec(A.obj.mcw);d.fillRect(c.plotArea.x2-g-8,c.plotArea.y2-2.5*b-8,g+4,2.5*b+8);d.fillStyle=t?A.ckDec(A.obj.mct):A.ckDec(A.obj.mcr);d.textBaseline="top";d.fillText(f,c.plotArea.x2-g-4,c.plotArea.y2-2.5*b-2);b=14;d.font=b+(t?"px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif":"px Lucida Sans Unicode");
...
!0,d=n.dataPoints[e].x.getTime()):d=n.dataPoints[e].x;f=z(n.dataPoints[e].y)?0:n.dataPoints[e].y;d<b.min&&(b.min=d);d>b.max&&(b.max=d);if(0<e){if(a.axisX.logarithmic){var y=d/n.dataPoints[e-1].x;1>y&&(y=1/y);b.minDiff>y&&1!==y&&(b.minDiff=y)}else y=d-n.dataPoints[e-1].x,0>y&&(y*=-1),b.minDiff>y&&0!==y&&(b.minDiff=y);null!==f&&null!==n.dataPoints[e-1].y&&(a.axisY.logarithmic?0<f&&(y=f/n.dataPoints[e-1].y,1>y&&(y=1/y),c.minDiff>y&&1!==y&&(c.minDiff=y)):(y=f-n.dataPoints[e-1].y,0>y&&(y*=-1),c.minDiff>
...
n+(a.axisX.logarithmic?1:0));p.dataPoints[n].x.getTime?(g=!0,d=p.dataPoints[n].x.getTime()):d=p.dataPoints[n].x;f=z(p.dataPoints[n].y)?null:p.dataPoints[n].y;d<b.min&&(b.min=d);d>b.max&&(b.max=d);if(0<n){if(a.axisX.logarithmic){var u=d/p.dataPoints[n-1].x;1>u&&(u=1/u);b.minDiff>u&&1!==u&&(b.minDiff=u)}else u=d-p.dataPoints[n-1].x,0>u&&(u*=-1),b.minDiff>u&&0!==u&&(b.minDiff=u);z(f)||null===p.dataPoints[n-1].y||(a.axisY.logarithmic?0<f&&(u=f/p.dataPoints[n-1].y,1>u&&(u=1/u),c.minDiff>u&&1!==u&&(c.minDiff=
...
p.xValueType=g?"dateTime":"number"}a.axisY.logarithmic?(c.max=z(c.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(c.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),c.min=z(c.viewPortMin)?1:Math.min(c.viewPortMin,1)):l&&!k?(c.max=z(c.viewPortMax)?99:Math.max(c.viewPortMax,99),c.min=z(c.viewPortMin)?1:Math.min(c.viewPortMin,1)):l&&k?(c.max=z(c.viewPortMax)?99:Math.max(c.viewPortMax,99),c.min=z(c.viewPortMin)?-99:Math.min(c.viewPortMin,-99)):!l&&k&&(c.max=z(c.viewPortMax)?-1:Math.max(c.viewPortMax,
-1),c.min=z(c.viewPortMin)?-99:Math.min(c.viewPortMin,-99));c.viewPortMin=c.min;c.viewPortMax=c.max;a.dataPointYSums=h}};B.prototype._processMultiYPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var c=a.axisY.dataInfo,b=a.axisX.dataInfo,d,f,g,l,k=!1,h=0;h<a.dataSeriesIndexes.length;h++){var m=this.data[a.dataSeriesIndexes[h]],p=0,n=!1,e=!1,q,r,s;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var w=this.sessionVariables.axisX.newViewportMinimum?this.sessionVariables.axisX.newViewportMinimum:
this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,u=this.sessionVariables.axisX.newViewportMaximum?this.sessionVariables.axisX.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(m.dataPoints[p].x&&m.dataPoints[p].x.getTime||"dateTime"===
m.xValueType)k=!0;for(p=0;p<m.dataPoints.length;p++){"undefined"===typeof m.dataPoints[p].x&&(m.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));m.dataPoints[p].x.getTime?(k=!0,d=m.dataPoints[p].x.getTime()):d=m.dataPoints[p].x;if((f=m.dataPoints[p].y)&&f.length){g=Math.min.apply(null,f);l=Math.max.apply(null,f);r=!0;for(var y=0;y<f.length;y++)null===f.k&&(r=!1);r&&(n||(s=q),q=d)}d<b.min&&(b.min=d);d>b.max&&(b.max=d);g<c.min&&(c.min=g);l>c.max&&(c.max=l);0<p&&(a.axisX.logarithmic?(r=d/m.dataPoints[p-
...
y=null;if(0<=m.dataSeries.type.indexOf("stacked")||"pie"===m.dataSeries.type||"doughnut"===m.dataSeries.type)u=this.getPercentAndTotal(m.dataSeries,m.dataPoint);if(m.dataSeries.indexLabelFormatter||m.dataPoint.indexLabelFormatter)y={chart:this,dataSeries:m.dataSeries,dataPoint:m.dataPoint,index:m.indexKeyword,total:u.total,percent:u.percent};var x=m.dataPoint.indexLabelFormatter?m.dataPoint.indexLabelFormatter(y):m.dataPoint.indexLabel?this.replaceKeywordsWithValue(m.dataPoint.indexLabel,m.dataPoint,
...
y?0:-90,text:x,padding:0,backgroundColor:q,horizontalAlign:"left",fontSize:h,fontFamily:n,fontWeight:l,fontColor:k,fontStyle:e,textBaseline:"top"});q.measureText();m.dataSeries.indexLabelMaxWidth=q.maxWidth;if("stackedarea100"===p){if(m.point.x<b.x1||m.point.x>b.x2||m.point.y<b.y1-1||m.point.y>b.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(m.dataPoint.x<Y.viewportMinimum||m.dataPoint.x>Y.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<A.viewportMinimum||Math.min.apply(null,
...
Y.viewportMaximum||m.bounds.x1>b.x2||m.bounds.x2<b.x1)continue}else if("candlestick"===p||"ohlc"===p){if(m.dataPoint.x<Y.viewportMinimum||m.dataPoint.x>Y.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<A.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>A.viewportMaximum)continue}else if(m.dataPoint.x<Y.viewportMinimum||m.dataPoint.x>Y.viewportMaximum)continue;f=l=2;"horizontal"===y?(k=q.width,h=q.height):(h=q.width,k=q.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||
...
type:v.type,size:v.size,color:x,borderColor:x,borderThickness:v.borderThickness})}(h[s].indexLabel||k.indexLabel||h[s].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:h[s],dataSeries:k,point:{x:w,y:u},direction:0>h[s].y===a.axisY.reversed?1:-1,color:e})}c.stroke();t&&b.stroke()}}N.drawMarkers(d);c.restore();c.beginPath();t&&b.beginPath();return{source:c,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};
...
!h[r-1].lineDashType))&&(u[u.length-1].newLineDashArray=p,m=k.nullDataLineDashType):(c(u),u=[])),w=!0;else{s=a.axisX.convertValueToPixel(s);w=a.axisY.convertValueToPixel(h[r].y);var y=k.dataPointIds[r];this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:l,dataPointIndex:r,x1:s,y1:w};u[u.length]={x:s,y:w};r<h.length-1&&(q!==(h[r].lineColor||e)||m!==(h[r].lineDashType||k.lineDashType))&&(q=h[r].lineColor||e,u[u.length-1].newStrokeStyle=q,b.setLineDash&&(h[r].lineDashType?(m=
h[r].lineDashType,u[u.length-1].newLineDashArray=G(m,k.lineThickness)):(m=k.lineDashType,u[u.length-1].newLineDashArray=n)));if(0<h[r].markerSize||0<k.markerSize){var x=k.getMarkerProperties(r,s,w,b);f.push(x);y=F(y);t&&f.push({x:s,y:w,ctx:d,type:x.type,size:x.size,color:y,borderColor:y,borderThickness:x.borderThickness})}(h[r].indexLabel||k.indexLabel||h[r].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:h[r],dataSeries:k,point:{x:s,y:w},direction:0>
...
dataPointIndex:k,x1:w,y1:h,x2:u,y2:y};b=F(b);t&&M(this._eventManager.ghostCtx,w,h,u,y,b,0,null,!1,!1,!1,!1);(r[k].indexLabel||q.indexLabel||r[k].indexLabelFormatter||q.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:r[k],dataSeries:q,point:{x:d,y:0<=r[k].y?h:y},direction:0>r[k].y===a.axisY.reversed?1:-1,bounds:{x1:w,y1:Math.min(h,y),x2:u,y2:Math.max(h,y)},color:b})}}}c.restore();t&&this._eventManager.ghostCtx.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:E.yScaleAnimation,
...
dataSeriesIndex:e,dataPointIndex:k,x1:y,y1:w,x2:h,y2:u};b=F(b);t&&M(this._eventManager.ghostCtx,y,w,h,u,b,0,null,!1,!1,!1,!1);(r[k].indexLabel||q.indexLabel||r[k].indexLabelFormatter||q.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:r[k],dataSeries:q,point:{x:0<=r[k].y?h:y,y:d},direction:0>r[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(y,h),y1:w,x2:Math.max(y,h),y2:u},color:b})}}}c.restore();t&&this._eventManager.ghostCtx.restore();return{source:c,dest:this.plotArea.ctx,
...
y:w,ctx:g,type:u.type,size:u.size,color:I,borderColor:I,borderThickness:u.borderThickness}));(q[r].indexLabel||e.indexLabel||q[r].indexLabelFormatter||e.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:q[r],dataSeries:e,point:{x:s,y:w},direction:0>q[r].y===a.axisY.reversed?1:-1,color:z})}d();N.drawMarkers(h)}}f.restore();t&&this._eventManager.ghostCtx.restore();return{source:f,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};
...
z=m.nullDataLineDashType):(c(),u=[])),q=!0;else{e=a.axisX.convertValueToPixel(e);q=a.axisY.convertValueToPixel(p[n].y);var C=m.dataPointIds[n];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:n,x1:e,y1:q};u[u.length]={x:e,y:q};n<p.length-1&&(v!==(p[n].lineColor||x)||z!==(p[n].lineDashType||m.lineDashType))&&(v=p[n].lineColor||x,u[u.length-1].newStrokeStyle=v,b.setLineDash&&(p[n].lineDashType?(z=p[n].lineDashType,u[u.length-1].newLineDashArray=G(z,m.lineThickness)):
(z=m.lineDashType,u[u.length-1].newLineDashArray=B)));if(0!==p[n].markerSize&&(0<p[n].markerSize||0<m.markerSize)){var V=m.getMarkerProperties(n,e,q,b);l.push(V);C=F(C);t&&l.push({x:e,y:q,ctx:d,type:V.type,size:V.size,color:C,borderColor:C,borderThickness:V.borderThickness})}(p[n].indexLabel||m.indexLabel||p[n].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[n],dataSeries:m,point:{x:e,y:q},direction:0>p[n].y===a.axisY.reversed?1:-1,color:y});
q=!1}c();N.drawMarkers(l)}}b.restore();t&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};B.prototype.renderStepArea=function(a){var c,b;function d(){v&&(0<e.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?x=y:0>a.axisY.viewportMaximum?x=k.y1:0<a.axisY.viewportMinimum&&(x=l.y2),f.lineTo(s,x),f.lineTo(v.x,x),f.closePath(),f.globalAlpha=
e.fillOpacity,f.fill(),f.globalAlpha=1,t&&(g.lineTo(s,x),g.lineTo(v.x,x),g.closePath(),g.fill()),f.beginPath(),f.moveTo(s,w),g.beginPath(),g.moveTo(s,w),v={x:s,y:w})}var f=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var g=this._eventManager.ghostCtx,l=a.axisX.lineCoordinates,k=a.axisY.lineCoordinates,h=[],m=this.plotArea,p;f.save();t&&g.save();f.beginPath();f.rect(m.x1,m.y1,m.width,m.height);f.clip();t&&(g.beginPath(),g.rect(m.x1,m.y1,m.width,m.height),g.clip());for(m=
0;m<a.dataSeriesIndexes.length;m++){var n=a.dataSeriesIndexes[m],e=this.data[n],q=e.dataPoints,h=e.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:n};h=F(h);g.fillStyle=h;h=[];c=!0;var r=0,s,w,u,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),x,v=null;b=!1;if(0<q.length){var z=e._colorSet[r%e._colorSet.length],A=e.lineColor=e.options.lineColor||z,B=A;f.fillStyle=z;f.strokeStyle=A;f.lineWidth=e.lineThickness;var C="solid";if(f.setLineDash){var V=
...
this._indexLabels.push({chartType:"stepArea",dataPoint:q[r],dataSeries:e,point:{x:s,y:w},direction:0>q[r].y===a.axisY.reversed?1:-1,color:z}))}d();N.drawMarkers(h)}}f.restore();t&&this._eventManager.ghostCtx.restore();return{source:f,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};B.prototype.renderStackedArea=function(a){function c(){if(!(1>k.length)){for(0<v.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);t&&s.lineTo(a.x,
a.y)}b.closePath();b.globalAlpha=v.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();t&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var b=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var d=null,f=[],g=this.plotArea,l=[],k=[],h=[],m=[],p=0,n,e,q,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,w,u,y;t&&s.beginPath();b.save();t&&s.save();b.beginPath();b.rect(g.x1,g.y1,g.width,g.height);b.clip();t&&(s.beginPath(),
s.rect(g.x1,g.y1,g.width,g.height),s.clip());d=[];for(g=0;g<a.dataSeriesIndexes.length;g++){var x=a.dataSeriesIndexes[g],v=this.data[x],z=v.dataPoints;v.dataPointIndexes=[];for(p=0;p<z.length;p++)x=z[p].x.getTime?z[p].x.getTime():z[p].x,v.dataPointIndexes[x]=p,d[x]||(h.push(x),d[x]=!0);h.sort(ya)}for(g=0;g<a.dataSeriesIndexes.length;g++){x=a.dataSeriesIndexes[g];v=this.data[x];z=v.dataPoints;u=!0;k=[];p=v.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:x};p=F(p);s.fillStyle=
p;if(0<h.length){var d=v._colorSet[0],A=v.lineColor=v.options.lineColor||d,B=A;b.fillStyle=d;b.strokeStyle=A;b.lineWidth=v.lineThickness;y="solid";if(b.setLineDash){var C=G(v.nullDataLineDashType,v.lineThickness);y=v.lineDashType;var V=G(y,v.lineThickness);b.setLineDash(V)}for(var W=!0,p=0;p<h.length;p++){q=h[p];var I=null,I=0<=v.dataPointIndexes[q]?z[v.dataPointIndexes[q]]:{x:q,y:null};if(!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!v.connectNullData||!W)))if("number"!==typeof I.y)v.connectNullData||
(W||u)||c(),W=!0;else{n=a.axisX.convertValueToPixel(q);var da=l[q]?l[q]:0;if(a.axisY.logarithmic){m[q]=I.y+(m[q]?m[q]:0);if(0>=m[q])continue;e=a.axisY.convertValueToPixel(m[q])}else e=a.axisY.convertValueToPixel(I.y),e-=da;k.push({x:n,y:r-da});l[q]=r-e;u||W?(!u&&v.connectNullData?(b.setLineDash&&(v.options.nullDataLineDashType||y===v.lineDashType&&v.lineDashType!==v.nullDataLineDashType)&&(u=k.pop(),y=k[k.length-1],c(),b.moveTo(w.x,w.y),k.push(y),k.push(u),y=v.nullDataLineDashType,b.setLineDash(C)),
b.lineTo(n,e),t&&s.lineTo(n,e)):(b.beginPath(),b.moveTo(n,e),t&&(s.beginPath(),s.moveTo(n,e))),W=u=!1):(b.lineTo(n,e),t&&s.lineTo(n,e),0==p%250&&(c(),b.moveTo(n,e),t&&s.moveTo(n,e),k.push({x:n,y:r-da})));w={x:n,y:e};p<z.length-1&&(B!==(z[p].lineColor||A)||y!==(z[p].lineDashType||v.lineDashType))&&(c(),b.beginPath(),b.moveTo(n,e),k.push({x:n,y:r-da}),B=z[p].lineColor||A,b.strokeStyle=B,b.setLineDash&&(z[p].lineDashType?(y=z[p].lineDashType,b.setLineDash(G(y,v.lineThickness))):(y=v.lineDashType,b.setLineDash(V))));
if(0<=v.dataPointIndexes[q]){var ea=v.dataPointIds[v.dataPointIndexes[q]];this._eventManager.objectMap[ea]={id:ea,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:v.dataPointIndexes[q],x1:n,y1:e}}0<=v.dataPointIndexes[q]&&0!==I.markerSize&&(0<I.markerSize||0<v.markerSize)&&(q=v.getMarkerProperties(v.dataPointIndexes[q],n,e,b),f.push(q),markerColor=F(ea),t&&f.push({x:n,y:e,ctx:s,type:q.type,size:q.size,color:markerColor,borderColor:markerColor,borderThickness:q.borderThickness}));(I.indexLabel||
v.indexLabel||I.indexLabelFormatter||v.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:I,dataSeries:v,point:{x:n,y:e},direction:0>z[p].y===a.axisY.reversed?1:-1,color:d})}}c();b.moveTo(n,e);t&&s.moveTo(n,e)}delete v.dataPointIndexes}N.drawMarkers(f);b.restore();t&&s.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};B.prototype.renderStackedArea100=function(a){function c(){for(0<v.lineThickness&&
b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);t&&y.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=v.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();t&&(y.closePath(),y.fill(),y.beginPath());k=[]}var b=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var d=null,f=this.plotArea,g=[],l=[],k=[],h=[],m=[],p=0,n,e,q,r,s,w,u=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),y=this._eventManager.ghostCtx;b.save();t&&y.save();b.beginPath();b.rect(f.x1,
f.y1,f.width,f.height);b.clip();t&&(y.beginPath(),y.rect(f.x1,f.y1,f.width,f.height),y.clip());d=[];for(f=0;f<a.dataSeriesIndexes.length;f++){var x=a.dataSeriesIndexes[f],v=this.data[x],z=v.dataPoints;v.dataPointIndexes=[];for(p=0;p<z.length;p++)x=z[p].x.getTime?z[p].x.getTime():z[p].x,v.dataPointIndexes[x]=p,d[x]||(h.push(x),d[x]=!0);h.sort(ya)}for(f=0;f<a.dataSeriesIndexes.length;f++){x=a.dataSeriesIndexes[f];v=this.data[x];z=v.dataPoints;s=!0;d=v.id;this._eventManager.objectMap[d]={objectType:"dataSeries",
dataSeriesIndex:x};d=F(d);y.fillStyle=d;k=[];if(0<h.length){var d=v._colorSet[p%v._colorSet.length],A=v.lineColor=v.options.lineColor||d,B=A;b.fillStyle=d;b.strokeStyle=A;b.lineWidth=v.lineThickness;w="solid";if(b.setLineDash){var C=G(v.nullDataLineDashType,v.lineThickness);w=v.lineDashType;var V=G(w,v.lineThickness);b.setLineDash(V)}for(var W=!0,p=0;p<h.length;p++){q=h[p];var I=null,I=0<=v.dataPointIndexes[q]?z[v.dataPointIndexes[q]]:{x:q,y:null};if(!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&
(!v.connectNullData||!W)))if("number"!==typeof I.y)v.connectNullData||(W||s)||c(),W=!0;else{var da;da=0!==a.dataPointYSums[q]?100*(I.y/a.dataPointYSums[q]):0;n=a.axisX.convertValueToPixel(q);var ea=l[q]?l[q]:0;if(a.axisY.logarithmic){m[q]=da+(m[q]?m[q]:0);if(0>=m[q])continue;e=a.axisY.convertValueToPixel(m[q])}else e=a.axisY.convertValueToPixel(da),e-=ea;k.push({x:n,y:u-ea});l[q]=u-e;s||W?(!s&&v.connectNullData?(b.setLineDash&&(v.options.nullDataLineDashType||w===v.lineDashType&&v.lineDashType!==
v.nullDataLineDashType)&&(s=k.pop(),w=k[k.length-1],c(),b.moveTo(r.x,r.y),k.push(w),k.push(s),w=v.nullDataLineDashType,b.setLineDash(C)),b.lineTo(n,e),t&&y.lineTo(n,e)):(b.beginPath(),b.moveTo(n,e),t&&(y.beginPath(),y.moveTo(n,e))),W=s=!1):(b.lineTo(n,e),t&&y.lineTo(n,e),0==p%250&&(c(),b.moveTo(n,e),t&&y.moveTo(n,e),k.push({x:n,y:u-ea})));r={x:n,y:e};p<z.length-1&&(B!==(z[p].lineColor||A)||w!==(z[p].lineDashType||v.lineDashType))&&(c(),b.beginPath(),b.moveTo(n,e),k.push({x:n,y:u-ea}),B=z[p].lineColor||
A,b.strokeStyle=B,b.setLineDash&&(z[p].lineDashType?(w=z[p].lineDashType,b.setLineDash(G(w,v.lineThickness))):(w=v.lineDashType,b.setLineDash(V))));if(0<=v.dataPointIndexes[q]){var Fa=v.dataPointIds[v.dataPointIndexes[q]];this._eventManager.objectMap[Fa]={id:Fa,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:v.dataPointIndexes[q],x1:n,y1:e}}0<=v.dataPointIndexes[q]&&0!==I.markerSize&&(0<I.markerSize||0<v.markerSize)&&(q=v.getMarkerProperties(p,n,e,b),g.push(q),markerColor=F(Fa),t&&g.push({x:n,
...
p>a.axisX.dataInfo.viewPortMax)&&null!==s[f].y&&s[f].y.length&&"number"===typeof s[f].y[0]&&"number"===typeof s[f].y[1]&&"number"===typeof s[f].y[2]&&"number"===typeof s[f].y[3]){g=a.axisX.convertValueToPixel(p);l=a.axisY.convertValueToPixel(s[f].y[0]);k=a.axisY.convertValueToPixel(s[f].y[1]);h=a.axisY.convertValueToPixel(s[f].y[2]);m=a.axisY.convertValueToPixel(s[f].y[3]);var u=g-n/2<<0,y=u+n<<0,d=s[f].color?s[f].color:r._colorSet[0],x=Math.round(Math.max(1,0.15*n)),v=0===x%2?0:0.5,z=r.dataPointIds[f];
this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:l,x2:y,y2:k,x3:g,y3:h,x4:g,y4:m,borderThickness:x,color:d};c.strokeStyle=d;c.beginPath();c.lineWidth=x;b.lineWidth=Math.max(x,4);"candlestick"===r.type?(c.moveTo(g-v,k),c.lineTo(g-v,Math.min(l,m)),c.stroke(),c.moveTo(g-v,Math.max(l,m)),c.lineTo(g-v,h),c.stroke(),M(c,u,Math.min(l,m),y,Math.max(l,m),s[f].y[0]<=s[f].y[3]?r.risingColor:d,x,d,w,w,!1,!1,r.fillOpacity),t&&(d=F(z),b.strokeStyle=d,b.moveTo(g-
...
h._colorSet.length],y=h.lineColor=h.options.lineColor||u,x=y;b.fillStyle=u;b.strokeStyle=y;b.lineWidth=h.lineThickness;var v="solid";if(b.setLineDash){var z=G(h.nullDataLineDashType,h.lineThickness),v=h.lineDashType,A=G(v,h.lineThickness);b.setLineDash(A)}for(var B=!0;n<m.length;n++)if(s=m[n].x.getTime?m[n].x.getTime():m[n].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!B)))if(null!==m[n].y&&m[n].y.length&&"number"===typeof m[n].y[0]&&"number"===typeof m[n].y[1]){e=
a.axisX.convertValueToPixel(s);q=a.axisY.convertValueToPixel(m[n].y[0]);r=a.axisY.convertValueToPixel(m[n].y[1]);p||B?(h.connectNullData&&!p?(b.setLineDash&&(h.options.nullDataLineDashType||v===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(l[l.length-1].newLineDashArray=A,v=h.nullDataLineDashType,b.setLineDash(z)),b.lineTo(e,q),t&&d.lineTo(e,q),l.push({x:e,y:r})):(b.beginPath(),b.moveTo(e,q),w={x:e,y:q},l=[],l.push({x:e,y:r}),t&&(d.beginPath(),d.moveTo(e,q))),B=p=!1):(b.lineTo(e,q),l.push({x:e,
...
f;var f=[],m=0,p,n,e,q=[],r=[];if(0<h.length){var s=k._colorSet[m%k._colorSet.length],w=k.lineColor=k.options.lineColor||s,u=w;b.fillStyle=s;b.lineWidth=k.lineThickness;var y="solid",x;if(b.setLineDash){var v=G(k.nullDataLineDashType,k.lineThickness),y=k.lineDashType;x=G(y,k.lineThickness)}for(n=!1;m<h.length;m++)if(p=h[m].x.getTime?h[m].x.getTime():h[m].x,!(p<a.axisX.dataInfo.viewPortMin||p>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!n)))if(null!==h[m].y&&h[m].y.length&&"number"===typeof h[m].y[0]&&
"number"===typeof h[m].y[1]){p=a.axisX.convertValueToPixel(p);n=a.axisY.convertValueToPixel(h[m].y[0]);e=a.axisY.convertValueToPixel(h[m].y[1]);var z=k.dataPointIds[m];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:l,dataPointIndex:m,x1:p,y1:n,y2:e};q[q.length]={x:p,y:n};r[r.length]={x:p,y:e};m<h.length-1&&(u!==(h[m].lineColor||w)||y!==(h[m].lineDashType||k.lineDashType))&&(u=h[m].lineColor||w,q[q.length-1].newStrokeStyle=u,b.setLineDash&&(h[m].lineDashType?(y=h[m].lineDashType,
q[q.length-1].newLineDashArray=G(y,k.lineThickness)):(y=k.lineDashType,q[q.length-1].newLineDashArray=x)));if(0!==h[m].markerSize&&(0<h[m].markerSize||0<k.markerSize)){var A=k.getMarkerProperties(m,p,n,b);f.push(A);var B=F(z);t&&f.push({x:p,y:n,ctx:d,type:A.type,size:A.size,color:B,borderColor:B,borderThickness:A.borderThickness});A=k.getMarkerProperties(m,p,e,b);f.push(A);B=F(z);t&&f.push({x:p,y:e,ctx:d,type:A.type,size:A.size,color:B,borderColor:B,borderThickness:A.borderThickness})}if(h[m].indexLabel||
...
var n={percent:null,total:null},r=null,n=h.getPercentAndTotal(m,g);if(m.indexLabelFormatter||g.indexLabelFormatter)r={chart:h.options,dataSeries:m,dataPoint:g,total:n.total,percent:n.percent};n=g.indexLabelFormatter?g.indexLabelFormatter(r):g.indexLabel?h.replaceKeywordsWithValue(g.indexLabel,g,m,f):m.indexLabelFormatter?m.indexLabelFormatter(r):m.indexLabel?h.replaceKeywordsWithValue(m.indexLabel,g,m,f):g.label?g.label:"";h._eventManager.objectMap[k]=l;l.center={x:x.x,y:x.y};l.y=g.y;l.radius=C;l.percentInnerRadius=
F;l.indexLabelText=n;l.indexLabelPlacement=m.indexLabelPlacement;l.indexLabelLineColor=g.indexLabelLineColor?g.indexLabelLineColor:m.options.indexLabelLineColor?m.options.indexLabelLineColor:g.color?g.color:m._colorSet[f%m._colorSet.length];l.indexLabelLineThickness=z(g.indexLabelLineThickness)?m.indexLabelLineThickness:g.indexLabelLineThickness;l.indexLabelLineDashType=g.indexLabelLineDashType?g.indexLabelLineDashType:m.indexLabelLineDashType;l.indexLabelFontColor=g.indexLabelFontColor?g.indexLabelFontColor:
...
markerColor:r,text:q,textBlock:null,chartType:n.type,markerSize:s,lineColor:n._colorSet[0],dataSeriesIndex:n.index,dataPointIndex:null,markerBorderColor:w,markerBorderThickness:u};h.push(e)}else for(var t=0;t<n.dataPoints.length;t++){var x=n.dataPoints[t],e=x.legendMarkerType?x.legendMarkerType:n.legendMarkerType?n.legendMarkerType:$.getDefaultLegendMarker(n.type),q=x.legendText?x.legendText:n.legendText?n.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,
dataSeries:n,dataPoint:x}):x.name?x.name:"DataPoint: "+(t+1),r=x.legendMarkerColor?x.legendMarkerColor:n.legendMarkerColor?n.legendMarkerColor:x.color?x.color:n.color?n.color:n._colorSet[t%n._colorSet.length],s=0.75*this.lineHeight,w=x.legendMarkerBorderColor?x.legendMarkerBorderColor:n.legendMarkerBorderColor?n.legendMarkerBorderColor:x.markerBorderColor?x.markerBorderColor:n.markerBorderColor,u=x.legendMarkerBorderThickness?x.legendMarkerBorderThickness:n.legendMarkerBorderThickness?n.legendMarkerBorderThickness:
x.markerBorderThickness||n.markerBorderThickness?Math.max(1,Math.round(0.2*s)):0,q=this.chart.replaceKeywordsWithValue(q,x,n,t),e={markerType:e,markerColor:r,text:q,textBlock:null,chartType:n.type,markerSize:s,dataSeriesIndex:p,dataPointIndex:t,markerBorderColor:w,markerBorderThickness:u};(x.showInLegend||n.showInLegend&&!1!==x.showInLegend)&&h.push(e)}}!0===this.reversed&&h.reverse();if(0<h.length){n=null;r=t=q=x=0;q=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,
...
e.chartType?2*0.1*this.lineHeight:0))>g)n={items:[],width:0},m.push(n),this.height+=t,t=0;t=Math.max(t,e.textBlock.height)}else e.textBlock=new U(this.ctx,{x:0,y:0,maxWidth:q,maxHeight:!0===this.itemWrap?l:1.5*this.fontSize,angle:0,text:e.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),e.textBlock.measureText(),null!==this.itemWidth&&(e.textBlock.width=this.itemWidth-
(s+k+("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType?2*0.1*this.lineHeight:0))),this.height<l-this.lineHeight?(n={items:[],width:0},m.push(n)):(n=m[x],x=(x+1)%m.length),this.height+=e.textBlock.height;e.textBlock.x=n.width;e.textBlock.y=0;n.width+=Math.round(e.textBlock.width+s+k+(0===n.width?0:this.horizontalSpacing)+("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType?2*0.1*this.lineHeight:0));n.items.push(e);this.width=Math.max(n.width,this.width);r=e.textBlock.width+
(s+k+("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=r;this.height=!1===this.itemWrap?m.length*this.lineHeight:this.height+t;this.height=Math.min(l,this.height);this.width=Math.min(g,this.width)}"top"===this.verticalAlign?(f="left"===this.horizontalAlign?c.x1:"right"===this.horizontalAlign?c.x2-this.width:c.x1+c.width/2-this.width/2,d=c.y1):"center"===this.verticalAlign?(f="left"===this.horizontalAlign?c.x1:"right"===this.horizontalAlign?
...
this.borderColor||this.backgroundColor)&&this.ctx.roundRect(f,d,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(p=c=0;p<m.length;p++){n=m[p];for(x=t=0;x<n.items.length;x++){e=n.items[x];r=e.textBlock.x+f+(0===x?0.2*s:this.horizontalSpacing);w=d+c;q=r;this.chart.data[e.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(f,d,g,Math.max(l-l%this.lineHeight,0));this.ctx.clip();if("line"===e.chartType||
...
e.chartType||"spline"===e.chartType)e.textBlock.x+=0.1*this.lineHeight;e.textBlock.y=Math.round(w+this.lineHeight/2);e.textBlock.render(!0);this.ctx.restore();t=0<x?Math.max(t,e.textBlock.height):e.textBlock.height;this.chart.data[e.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);r=F(e.id);this.ghostCtx.fillStyle=r;this.ghostCtx.beginPath();this.ghostCtx.fillRect(q,e.textBlock.y-this.lineHeight/2,e.textBlock.x+e.textBlock.width-q,e.textBlock.height);e.x1=this.chart._eventManager.objectMap[e.id].x1=
q;e.y1=this.chart._eventManager.objectMap[e.id].y1=e.textBlock.y-this.lineHeight/2;e.x2=this.chart._eventManager.objectMap[e.id].x2=e.textBlock.x+e.textBlock.width;e.y2=this.chart._eventManager.objectMap[e.id].y2=e.textBlock.y+e.textBlock.height-this.lineHeight/2}c+=t}0<h.length&&a.layoutManager.registerSpace(b,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:f,y1:d,x2:f+this.width,y2:d+this.height}};S(Ca,L);Ca.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace();
...
k)},b[e].bounds={x1:l-(y[e]+N),y1:k,x2:h,y2:m,width:h-l,height:m-k},b[e].title&&(b[e]._titleTextBlock.maxWidth=0<b[e].titleMaxWidth&&b[e].titleMaxWidth<b[e].lineCoordinates.height?b[e].titleMaxWidth:b[e].lineCoordinates.height),N+=y[e]+b[e].margin);if(d&&0<d.length)for(e=0;e<d.length;e++)d[e]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:c[0].lineCoordinates.x2),h=Math.round(l),D=d[e]._labels&&0<d[e]._labels.length?d[e]._labels[d[e]._labels.length-1].textBlock.height/2:0,k=Math.round(g.y1+T+K<Math.max(D,
10)?Math.max(D,10):g.y1+T+K),D=0<a.length?0:d[e]._labels&&0<d[e]._labels.length?d[e]._labels[0].textBlock.height/2:0,m=Math.round(g.y2-(X+f+D)),d[e].lineCoordinates={x1:l+O,y1:k,x2:l+O,y2:m,height:Math.abs(m-k)},d[e].bounds={x1:l,y1:k,x2:h+(x[e]+O),y2:m,width:h-l,height:m-k},d[e].title&&(d[e]._titleTextBlock.maxWidth=0<d[e].titleMaxWidth&&d[e].titleMaxWidth<d[e].lineCoordinates.height?d[e].titleMaxWidth:d[e].lineCoordinates.height),O+=x[e]+d[e].margin);if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&
...
n.clip();if(a&&0<a.length)for(e=0;e<a.length;e++)a[e].renderLabelsTicksAndTitle();if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].renderLabelsTicksAndTitle();n.restore();if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].renderLabelsTicksAndTitle();if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].renderLabelsTicksAndTitle()}else{v=[];A=[];B=[];r=[];s=[];I=[];H=[];L=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&a[e].title&&(a[e]._titleTextBlock.maxWidth=a[e].titleMaxWidth||g.width,a[e]._titleTextBlock.maxHeight=
...
40,d=4;"axisX"===this.type&&(d=600>this.maxWidth?8:6);var a=Math.max(d,Math.floor(this.maxWidth/a)),f,g,l,d=0;!z(this.options.viewportMinimum)&&(!z(this.options.viewportMaximum)&&this.options.viewportMinimum>=this.options.viewportMaximum)&&(this.viewportMinimum=this.viewportMaximum=null);if(z(this.options.viewportMinimum)&&!z(this.sessionVariables.newViewportMinimum)&&!isNaN(this.sessionVariables.newViewportMinimum))this.viewportMinimum=this.sessionVariables.newViewportMinimum;else if(null===this.viewportMinimum||
...
b);h.dataSeries=f;this.currentDataPointIndex=h.index;d=h.dataPoint}if(!z(h.dataPoint.y))if(h.dataSeries.axisY)if(0<h.dataPoint.y.length){for(d=b=0;d<h.dataPoint.y.length;d++)h.dataPoint.y[d]<h.dataSeries.axisY.viewportMinimum?b--:h.dataPoint.y[d]>h.dataSeries.axisY.viewportMaximum&&b++;b<h.dataPoint.y.length&&b>-h.dataPoint.y.length&&g.push(h)}else"column"===f.type||"bar"===f.type?0>h.dataPoint.y?0>h.dataSeries.axisY.viewportMinimum&&h.dataSeries.axisY.viewportMaximum>=h.dataPoint.y&&g.push(h):h.dataSeries.axisY.viewportMinimum<=
