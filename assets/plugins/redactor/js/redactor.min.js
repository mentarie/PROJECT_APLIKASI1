...
(function($) {
    ...
    Redactor.fn = $.Redactor.prototype = {
        ...
        init: function(el, options) {
            ...
            this.opts = $.extend({}, opts, this.$element.data(), options);
            this.start = true;
            this.dropdowns = [];
            ...
            if (this.opts.linebreaks === false) {
                if (this.opts.allowedTags !== false) {
                    ...
                    if ($.inArray("p", this.opts.allowedTags) === "-1") {
                        this.opts.allowedTags.push("p")
                    }
                    for (i in arrSearch) {
                        if ($.inArray(arrSearch[i], this.opts.allowedTags) != "-1") {
                            this.opts.allowedTags.push(arrAdd[i])
                        }
                    }
                }
        ...
        buildOptions: function() {
            ...
            if (this.opts.tabindex) {
                $source.attr("tabindex", this.opts.tabindex)
            }
            if (this.opts.minHeight) {
                $source.css("min-height", this.opts.minHeight + "px")
            } else {
            ...
            if (this.opts.typewriter) {
                this.$editor.addClass("redactor-editor-typewriter")
            }
            if (!this.opts.autoresize) {
                $source.css("height", this.sourceHeight)
            }
        },
        buildAfter: function() {
            this.start = false;
        ...
        buildEventKeydown: function(e) {
            ...
            if (key === this.keyCode.DOWN) {
                if (parent && $(parent)[0].tagName === "BLOCKQUOTE") {
                    this.insertAfterLastElement(parent)
                }
                if (current && $(current)[0].tagName === "BLOCKQUOTE") {
                    this.insertAfterLastElement(current)
                }
            ...
            if (ctrl && key === 65) {
                ...
                if (key != this.keyCode.LEFT_WIN && !ctrl) {
                    this.selectall = false
                }
            }
                    ...
                    if (!this.opts.linebreaks) {
                        if (block && block.tagName == "LI") {
                            ...
                            if (listCurrent !== false || listCurrent.tagName === "LI") {
                                ...
                                if (listText == "" && listCurrentText == "" && $(listCurrent).next("li").size() == 0 && $(listCurrent).parents("li").size() == 0) {
                                    this.bufferSet();
            ...
            if (key === this.keyCode.BACKSPACE) {
                this.buildEventKeydownBackspace(e, current, parent)
            }
        },
        ...
        placeholderGet: function() {
            var ph = $('<span class="redactor_placeholder">').data("redactor", "verified").attr("contenteditable", false).text(this.placeholderText);
            if (this.opts.linebreaks === false) {
                return $("<p>").append(ph)
            } else {
                return ph
        ...
        dropdownBuild: function($dropdown, dropdownObject) {
            $.each(dropdownObject, $.proxy(function(btnName, btnObject) {
                ...
                var $item;
                if (btnObject.name === "separator") {
                    $item = $('<a class="redactor_separator_drop">')
                } else {
                    ...
                    $item.on("click", $.proxy(function(e) {
                        ...
                        if (btnObject.callback) {
                            btnObject.callback.call(this, btnName, $item, btnObject, e)
                        }
                        if (btnObject.exec) {
        ...
        buttonBuild: function(btnName, btnObject, buttonImage) {
            ...
            $button.on("click", $.proxy(function(e) {
                ...
                if ($button.hasClass("redactor_button_disabled")) {
                    return false
                }
                ...
                if (btnObject.exec) {
                    ...
                    if (btnObject.func && btnObject.func !== "show") {
                        this[btnObject.func](btnName);
                        this.airBindMousemoveHide()
                    } else {
                        if (btnObject.callback) {
        ...
        execCommand: function(cmd, param, sync) {
            ...
            if (cmd === "insertunorderedlist" || cmd === "insertorderedlist") {
                return this.execLists(cmd, param)
            }
            if (cmd === "unlink") {
                return this.execUnlink(cmd, param)
            }
        ...
        cleanEmpty: function(html) {
            ...
            if (this.opts.linebreaks === false) {
                if (html === "") {
                    ...
                    if (html.search(/^<hr\s?\/?>$/gi) !== -1) {
                        html = "<hr>" + this.opts.emptyHtml
                    }
                }
            }
            return html
        ...
        cleanConvertProtected: function(html) {
            ...
            if (this.opts.phpTags) {
                html = html.replace(/<\?php([\w\W]*?)\?>/gi, '<section style="display: none;" rel="redactor-php-tag">$1</section>')
            } else {
                html = html.replace(/<\?php([\w\W]*?)\?>/gi, "")
            }
            return html
        },
        cleanReConvertProtected: function(html) {
            ...
            if (this.opts.phpTags) {
                html = html.replace(/<section style="display: none;" rel="redactor-php-tag">([\w\W]*?)<\/section>/gi, "<?php\r\n$1\r\n?>")
            }
            return html
        },
        ...
        cleanParagraphy: function(html) {
            ...
            if (commentsMatches) {
                matches = $.merge(matches, commentsMatches)
            }
            if (this.opts.phpTags) {
        ...
        cleanConvertInlineTags: function(html, set) {
            ...
            if (this.opts.boldTag === "strong") {
                html = html.replace(/<b>([\w\W]*?)<\/b>/gi, "<strong>$1</strong>")
            } else {
                html = html.replace(/<strong>([\w\W]*?)<\/strong>/gi, "<b>$1</b>")
            }
            if (this.opts.italicTag === "em") {
                html = html.replace(/<i>([\w\W]*?)<\/i>/gi, "<em>$1</em>")
            } else {
        ...
        cleanSavePreCode: function(html, encode) {
            ...
            if (pre !== null) {
                $.each(pre, $.proxy(function(i, s) {
                    ...
                    if (encode !== false) {
                        arr[3] = this.cleanEncodeEntities(arr[3])
                    }
                    arr[3] = arr[3].replace(/\$/g, "&#36;");
                ...
                if ("!--" == tag.substr(1, 3)) {
                    ...
                    if ("!" == tag[1]) {
                        ...
                        if ("?" == tag[1]) {
                            ...
                            if (t = tag.match(/^<(script|style|pre)/i)) {
                                t[1] = t[1].toLowerCase();
        ...
        formatChangeTag: function(fromElement, toTagName, save) {
            ...
            $(fromElement).replaceWith(function() {
        ...
        inlineSetClass: function(className) {
            ...
            if (!$(current).hasClass(className)) {
                this.inlineMethods("addClass", className)
            }
        },
        ...
        inlineRemoveFormat: function(tag) {
            ...
            $.each(nodes, function(i, s) {
                if (s.tagName === utag) {
                    this.inlineRemoveFormatReplace(s)
                }
            });
            if (parent && parent[0].tagName === utag) {
                this.inlineRemoveFormatReplace(parent)
            }
            this.selectionRestore();
            this.sync()
        ...
        getParent: function(elem) {
            ...
            if (elem) {
                return this.isParentRedactor($(elem).parent()[0])
            } else {
                return false
            }
        },
        ...
        getNodes: function(range, tag) {
            ...
            if (!sel.isCollapsed) {
                nodes = this.getRangeSelectedNodes(sel.getRangeAt(0))
            }
            $.each(nodes, $.proxy(function(i, node) {
                if (this.opts.iframe === false && $(node).parents("div.redactor_editor").size() == 0) {
                    return false
        ...
        modalInit: function(title, content, width, callback) {
            ...
            if (this.isMobile() === false) {
                this.modalShowOnDesktop()
            } else {
                this.modalShowOnMobile()
            }
        ...
        isParentRedactor: function(el) {
            ...
            if ($(el).parents("div.redactor_editor").length == 0 || $(el).hasClass("redactor_editor")) {
                return false
            } else {
                return el
            }
    ...
    $.Redactor.fn.formatLinkify = function(protocol, convertLinks, convertImageLinks, convertVideoLinks, linkSize) {
        ...
        while (i--) {
            ...
            if (n.nodeType === 3) {
                ...
                if (n.nodeType === 1 && !/^(a|button|textarea)$/i.test(n.tagName)) {
